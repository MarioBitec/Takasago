page 50906 "BTC CRM Posted Sales Invoice"
{
    APIGroup = 'takasago';
    APIPublisher = 'bitec';
    APIVersion = 'v2.0';
    Caption = 'API Posted Sales Invoice', Comment = 'ESP="Factura de venta registrada"';
    Description = 'Página expuesta como WS para CRM';
    DelayedInsert = false;
    DeleteAllowed = false;
    EntityCaption = 'crmPostedSalesInvoice';
    EntityName = 'crmPostedSalesInvoice';
    EntitySetCaption = 'crmPostedSalesInvoices';
    EntitySetName = 'crmPostedSalesInvoices';
    Extensible = true;
    InsertAllowed = false;
    ModifyAllowed = false;
    ...
    layout
    {
        area(Content)
        {
            repeater(General)
            {
                ...
                {
                    Caption = 'Payment Method Code', Comment = 'ESP="Cód. forma pago"';
                }
